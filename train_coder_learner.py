...
parser.add_argument('--models_folder', default='saved_LSTM_models/', metavar='DIR',
                    help='folder to save models')
parser.add_argument('--embedding_size', default=200, type=int, metavar='N', help='Embedding dimension size, default: 200')
...
parser.add_argument('--lr', default=0.0005, type=float, metavar='N', help='Adam learning rate, default: 0.0001')
